...
test.only('Login to gebiz', async t => {
    ...
    const PIN = await waitForPIN(100000);
    ...
    // await t.click("#pt1\\:ot8");
    // // await t.waitFor("#pt1\\:r1\\:0\\:soc1\\:\\:content");
    // // await t.waitFor("#pt1\\:r1\\:0\\:pgl5");
    // await t.wait(10000);
    // await t.takeScreenshot();
    // await t.click("#pt1\\:cl6ii");
